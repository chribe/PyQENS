...
class Measurement:
    """this is a container for the data collected in a single run and information regarding that measurement
        Attributes
        ----------
        sample: str
    ...
    @staticmethod
    def load_data(pathraw,filepath_analysed,run_num):
        ...
        new_measurement.sample            = (f_raw['/entry0/subtitle'][0]).decode()
        ...
        new_measurement.run_num           = (f_raw['/entry0/run_number'][0])
        new_measurement.temperature_final = (f_raw['/entry0/sample/setpoint_temperature'][0])
