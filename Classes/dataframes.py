...
#filepath_analysed='\\\\moneta.uni-tuebingen.de\\groupshare\\Biophysics\\group_share\\Beamtime\\ILL-IN16B-9-13-829-22022020\\exp_9-13-829\\reducedFWS\\Reduceddata_singleruns\\'
...
#MTD.config.appendDataSearchDir( filepath_van)

# make a dictionary with all the measurement
vanadium=''
...
#meas = Data(namesample='Vanadium',run_num=range(268786,268793))
